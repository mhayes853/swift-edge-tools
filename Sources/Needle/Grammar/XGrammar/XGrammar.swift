  ...
  public final class XGrammarMatcher {
    ...
    public func bitmask() -> GrammarBitmask {
      var bitmask = GrammarBitmask(wordCount: self.bitmaskWordCount)
      _ = bitmask.storage.withUnsafeMutableBufferPointer {
