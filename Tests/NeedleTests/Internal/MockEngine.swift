...
private typealias MockGenerationTaskValue = Task<NeedleEngineGeneration, MockGenerationError>

final class MockEngine: NeedleEngine, Sendable {
  final class GenerationTask: NeedleEngineGenerationTask {
